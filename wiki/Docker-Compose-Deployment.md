...
You will see:
- `instagram_saved_posts_app`: Next.js web application and scraper engine (port 5050).
- `instagram_saved_posts_qdrant`: Qdrant vector search database & dashboard (port 6335).
