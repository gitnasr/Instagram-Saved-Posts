...
| :--- | :--- |
| Any standard group / admin | **Full Access**: Can add profiles, update cookies, trigger scrapes, edit notes, and export CSVs. |
| `viewer` or `viewers` | **Read-Only Mode**: Can browse accounts, view saved posts, read timelines, but cannot edit settings or initiate scrapes. |
